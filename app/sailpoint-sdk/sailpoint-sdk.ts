 ...
 * @throws {RequiredError}
 */
export let createUploadedConfiguration = (requestParameters: sdk.ConfigurationHubV2025ApiCreateUploadedConfigurationRequest, apiConfig: sdk.Configuration): Promise<ApiResponse<sdk.BackupResponseV2025>> => {
    const configurationhubv2025api = new sdk.ConfigurationHubV2025Api(apiConfig);
