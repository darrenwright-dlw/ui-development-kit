Generate `.shipmate/product/roadmap.md` with an ordered feature checklist:
...
1. **Review the Mission** - Read `.shipmate/product/mission.md` to understand the product's goals, target users, and success criteria.
