...
1. **Read Product Mission**: Load `.shipmate/product/mission.md` to understand:
...
2. **Read Product Roadmap**: Load `.shipmate/product/roadmap.md` to understand:
...
3. **Read Product Tech Stack**: Load `.shipmate/product/tech-stack.md` to understand:
