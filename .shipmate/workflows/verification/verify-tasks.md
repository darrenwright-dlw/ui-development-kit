Check `.shipmate/specs/[this-spec]/tasks.md` and ensure that all tasks and their sub-tasks are marked as completed with `- [x]`.
...
- Check for existence of an implementation report titled using this task's title in `.shipmate/spec/[this-spec]/implementation/` folder.
